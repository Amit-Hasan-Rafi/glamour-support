...
function AboutArtist() {
  return (
    <div className='text-center lg:ml-60 lg:mr-60 mr-10 ml-10'>
      ...
      <h1 className='text-6xl font-bold '>Pat McGrath</h1>
      <p className='font-semibold'> The queen of American fashion, Vogue’s Anna Wintour, proclaimed her “the most influential makeup artist in the world.” Britain’s Queen Elizabeth II made her a Member of the Order of the British Empire for services to the fashion and beauty industry. It’s undeniable: Pat McGrath is the most influential and sought-after makeup artist in the world.
        ...
        With a creative vision that’s made her a tour de force that touches everything from couture to club kids and street culture; her influence is everywhere, from screen to stage to digital: it’s undeniable, Pat McGrath knows no boundaries.</p>
      <div className="divider"></div>
    </div>
  )
}
